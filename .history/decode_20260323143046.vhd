...
architecture Behavioral of decode is
    ...
    signal mode_ALU_internal         : std_logic_vector(2 downto 0);
    signal src_ALU_internal          : std_logic;
    signal wr_en_MEM_internal        : std_logic;
    signal wr_en_REG_internal        : std_logic;
    signal sel_WB_internal           : std_logic_vector(1 downto 0);
    signal in_p_EN_internal          : std_logic;
    signal out_p_EN_internal         : std_logic;
    signal pc_src_internal           : std_logic;
    signal pc_reset_internal         : std_logic_vector(15 downto 0);
begin
