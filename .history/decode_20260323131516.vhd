...
begin
    ...
    process() -- needs to run whenever the outputs from the decoder change (opcode, destination_reg, source_1, source_2, shift_amount, disp_long, disp_short) but it doesn't matter if it runs more often than that
    begin
        case opcode is
            when OP_NOP =>
