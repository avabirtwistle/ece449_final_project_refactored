...
HD_PWD='C:/Users/zerrr/Desktop/ece449_final_project_refactored/ECE449 Project Refactored.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Top_Level_CPU.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Top_Level_CPU.tcl
