...
REM
REM Generated by Vivado on Sun Apr 05 13:10:45 -0700 2026
...
echo "xvhdl --incr --relax -prj tb_FormatA_Test_vhdl.prj"
call xvhdl  --incr --relax -prj tb_FormatA_Test_vhdl.prj -log xvhdl.log
